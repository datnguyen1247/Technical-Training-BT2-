...
export class MigrationCreatetablev61740543396810 implements MigrationInterface {
    name = 'MigrationCreatetablev61740543396810'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`shop\` (\`shopify_domain\` varchar(255) NOT NULL, \`active\` int NOT NULL, \`access_token\` varchar(255) NULL, \`shopify_access_scopes_granted\` varchar(500) NULL, \`shop_owner\` varchar(255) NULL, \`storefront_access_token\` varchar(255) NULL, \`shopify_plan\` varchar(255) NULL, \`email\` varchar(255) NULL, \`country\` varchar(255) NULL, \`money_format\` varchar(255) NULL, \`money_with_currency_format\` varchar(255) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`shopify_domain\`)) ENGINE=InnoDB`);
